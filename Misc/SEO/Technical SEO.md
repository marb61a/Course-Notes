...
Carrying out a technical audit
  ...
  - Step By Step Technical Audit
    ...
    - Review the data obtained by the crawlers and extract the top level insights
    - Export the data to a tool which can be used to dig deeper and understand why issues are happening
    - Double check and then verify anything that looks out of place
    - Run the top pages through a couple of tools
    - Put together a shortlist of issues

Building a backlog
  - 
  - What is a Technical Backlog
    - This is a prioritised list of Technical SEO issues which is found in the auditing process
    - This will allow for issue fixes to be tracked and implemented
    - The backlog will usually contain a greater level of detail than is contained in the audit documents
    - This is intended to be shared with development teams so that the progress of fixes can be tracked
    - It should be treated as a living document where updates and changes hould be made within
  - How do we create a Technical Backlog
    - From the list of steps involved in auditing a website a shortlist of site issues should be generated
